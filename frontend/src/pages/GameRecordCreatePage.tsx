        ...
        <>
          ...
          <div className="flex justify-end">
            <button
              ...
              disabled={createGameRecordMutation.isPending || hasDuplicatePlayers() || (['east', 'south', 'west', 'north'] as Position[]).reduce((acc, k) => acc + (Number(positions[k].point) || 0), 0) !== 100000}
